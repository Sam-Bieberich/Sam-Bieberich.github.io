...
<div style="margin-bottom: 10px;">
  <img src="/assets/knuth_books.png" alt="Books I obtained from the library" style="max-width: 100%; height: auto; margin-bottom: 5px;">
  <p style="text-align: center; font-style: italic; margin-top: 0;">Books I obtained from the library</p>
</div>
