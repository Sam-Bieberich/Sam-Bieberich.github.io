---
layout: post
title: The Many Types of Quantum Computers
---

{{ page.title }}
================

<p class="meta">3 Nov 2024</p>
...
<div style="margin-bottom: 10px;">
  <img src="/assets/qc-types.png" alt="Examples of some of the most well-regarded NISQ quantum hardware models" style="max-width: 100%; height: auto; margin-bottom: 5px;">
  <p style="text-align: center; font-style: italic; margin-top: 0;">Examples of some of the most well-regarded NISQ quantum hardware models (citations below)</p>
</div>
...
- [Journey to the Center of a Quantum Computer](https://www.popsci.com/technology/in-photos-journey-to-the-center-of-a-quantum-computer/)
- [Tutorial: Trapped Ions](https://pennylane.ai/qml/demos/tutorial_trapped_ions)
- [Trapped-Ion Quantum Computing: Progress and Challenges](https://arxiv.org/pdf/1904.04178.pdf)
- [Tutorial: Photonic Quantum Computers](https://pennylane.ai/qml/demos/tutorial_photonics#photonic-quantum-computers)
- [Differences Between Quantum Annealers and Gate-Based Quantum Computing](https://quantumzeitgeist.com/differences-between-quantum-annealers-and-gate-based-quantum-computing/)

Photo references (clockwise from top left):

- [Trapped-ion Chip (Sandia NL)](https://www.nature.com/articles/npjqi201634)
- [D-Wave Advantage](https://thequantuminsider.com/2022/07/01/d-wave-quantum-computer/)
- [Xanadu Borealis](https://www.wired.com/story/quantum-advantage-showdowns-have-no-clear-winners/)
- [Google SC](https://research.google/blog/quantum-supremacy-using-a-programmable-superconducting-processor/)
